...
class __TwigTemplate_1f6936bab6e20cc3f112187aaf380406603123758492f9ffdcc75eac7d399b5b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"mb-5\">Création d'une commande</h1>
...
{% block body %}
    <h1 class=\"mb-5\">Création d'une commande</h1>
    <div class=\"btn-group\" role=\"group\" aria-label=\"Basic example\">
        <button type=\"button\" class=\"btn btn-outline-primary\">    {{ include('commande/_form.html.twig') }}
        </button>
        <button type=\"button\" class=\"btn btn-secondary\"> <a href=\"{{ path('commande_index') }}\"> <i class=\"fa fa-arrow-circle-left\" aria-hidden=\"true\"></i>
            retour à la liste </a>
        </button>
      </div>

{% endblock %}
", "commande/new.html.twig", "C:\\wamp\\www\\tranquil-chamber-71759\\templates\\commande\\new.html.twig");
    }
}
